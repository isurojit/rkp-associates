...
export default function TaxConsultancyServices() {
    ...
    <main className="min-h-screen overflow-x-hidden bg-white">
      ...
      >
        ...
        >
          ...
          >
            Ensuring tax compliance in today's dynamic environment with
            ever-changing regulatory and tax requirements.
          </motion.p>
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          >
            <div className="lg:col-span-2 space-y-8">
              <motion.div variants={fadeInUp}>
                ...
                <p className="text-lg text-secondary-600 leading-relaxed mb-6">
                  Ensuring tax compliance has become increasingly complex in
                  today's dynamic environment, with ever-changing regulatory and
                  tax requirements. At RKP, our compliance and representation
                  services aim to instill confidence that your tax matters are
                  being dealt cost effectively and in a timely manner.
                </p>
                <p className="text-lg text-secondary-600 leading-relaxed">
                  We advise and assist in tax compliance for individual,
                  partnership and corporate tax to help you avoid unnecessary
                  litigation from the income tax department. Our range of Direct
                  and Indirect Tax services cover all aspects of Indian Tax
                  Laws.
                </p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp}>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    {
                      icon: FileText,
                      text: "Tax consultancy on domestic & international income tax",
                    },
                    {
                      icon: Scale,
                      text: "Representation before tax officers & appellate authorities",
                    },
                    {
                      icon: Globe,
                      text: "Transfer pricing studies & representation",
                    },
                    {
                      icon: TrendingUp,
                      text: "Cross border investments & international joint ventures",
                    },
                    { icon: Calculator, text: "All aspects of GST services" },
                    {
                      icon: Shield,
                      text: "Tax planning & optimization strategies",
                    },
                  ].map((item, index) => (
                    <motion.div
                      key={index}
            ...
            <div className="space-y-8">
              ...
              >
                <h3 className="text-xl font-bold mb-4">Optimize Your Taxes</h3>
                <p className="text-primary-100 mb-6">
                  Get expert tax planning and compliance support.
                </p>
                <Link
                  href="/contact"
