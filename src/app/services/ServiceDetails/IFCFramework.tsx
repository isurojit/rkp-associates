...
export default function IFCFramework() {
      ...
      >
        <motion.div style={{ y: heroY }} className="absolute inset-0 z-0">
          ...
          <Image
            ...
            alt="IFC Framework Implementation"
            fill
        ...
        >
          ...
          >
            Internal Financial Control framework as per Companies Act 2013 for
            ...
            <div className="lg:col-span-2 space-y-8">
              <motion.div variants={fadeInUp}>
                ...
                <p className="text-lg text-secondary-600 leading-relaxed mb-6">
                  ...
                  (IFC) has been defined as policies and procedures adopted by
                  companies to ensure orderly and efficient conduct of its
                  business, including adherence to company policies,
                  safeguarding of its assets, prevention and detection of fraud
                  and error, accuracy and completeness of accounting records,
              ...
              <motion.div variants={fadeInUp}>
                ...
                <p className="text-lg text-secondary-600 leading-relaxed mb-6">
                  Establish and review internal controls framework covering both
                  Entity Level Controls and Process Controls (covering finance
                  and accounts, business processes, compliance and IT) in line
                  with leading industry/controls practices. Benchmark controls
                  against global prevent vs detect, manual vs automated.
                </p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp}>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    {
                      icon: FileCheck,
                      text: "IFC/ICFR Framework Implementation",
                    },
                    {
                      icon: BarChart3,
                      text: "Quarterly limited review for listed entities",
                    },
                    { icon: Target, text: "Enterprise Risk Management" },
                    { icon: Shield, text: "Compliance Management" },
                    {
                      icon: TrendingUp,
                      text: "Business Performance Management",
                    },
                    { icon: CheckCircle, text: "Controls Transformation" },
                  ].map((item, index) => (
                    <motion.div
                      key={index}
                      whileHover={{ x: 8 }}
            ...
            <div className="space-y-8">
              ...
              >
                <h3 className="text-xl font-bold mb-4">
                  Implement IFC Framework
                </h3>
                <p className="text-primary-100 mb-6">
                  Get compliant with Companies Act 2013.
                </p>
                <Link
                  href="/contact"
