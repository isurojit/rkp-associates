            ...
            <div className="lg:col-span-2 space-y-8">
              <motion.div variants={fadeInUp}>
                ...
                <p className="text-lg text-secondary-600 leading-relaxed mb-6">
                  Using a risk-based approach and proven methodology, we focus
                  on evaluating the effectiveness of your internal controls
                  against key risks, business strategy and commercial needs.
                  When you work with us, you will have the confidence that our
                  services will meet your compliance and business needs.
                </p>
                <p className="text-lg text-secondary-600 leading-relaxed">
                  We use data analytics extensively in order to do all round
                  analysis of the respective process areas.
                </p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp}>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    {
                      icon: Database,
                      text: "Process control evaluations with automation",
                    },
                    {
                      icon: Shield,
                      text: "Verify General Controls & Cyber Security",
                    },
                    {
                      icon: BarChart3,
                      text: "Financial data analysis & IT Systems evaluation",
                    },
                    {
                      icon: FileCheck,
                      text: "Evaluation of governance, risk and compliances",
                    },
                    {
                      icon: TrendingUp,
                      text: "Evaluation of Procure to Pay Process",
                    },
                    { icon: Users, text: "Analysis of HR & Payroll Process" },
                    {
                      icon: CheckCircle,
                      text: "Compliance to Statutory norms",
                    },
                  ].map((item, index) => (
                    <motion.div
                      key={index}
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="space-y-4">
                  {[
                    { role: "Partners", count: 6 },
                    { role: "Qualified Assistants", count: 8 },
                    { role: "Audit Assistants", count: 15 },
                  ].map((member, index) => (
                    <div
                      key={index}
